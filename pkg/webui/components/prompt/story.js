...
storiesOf('Prompt', module).add('Default', () => (
  <div>
    ...
    >
      <p>
        This modal prompts the user to confirm current route change. By pressing `Approve` the user
        blocks navigation, while pressing `Cancel` allows navigation to happen.
      </p>
    </Prompt>
  </div>
))
